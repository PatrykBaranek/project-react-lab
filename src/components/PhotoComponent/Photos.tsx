...
import './Photos.css';
import { IAlbum, IPhoto, IUser } from '../../types/types';
...
export const Photos: FC<IPhotoProps> = ({ photos, albumId, username, albumTitle }) => {
  return (
    <div className="photos-container">
      ...
      {photos &&
        photos.map((photo) => (
          <div
            key={photo.id}
            className={`photo-img-container ${photos.length === 1 ? 'single-photo' : ''}`}
          >
